    ...
    <div class=" h-screen w-full flex justify-center items-center bg-[#F0F7F4]">
        <form class="w-96 bg-[#32292F] p-10">
            ...
            <div class="">
                ...
                <input placeholder="Password" type="password" class="w-full p-3" required />
                <input placeholder="Confirm Password" type="password" class="w-full my-4 p-3" required />
            </div>
            <button type="submit"
                class="text-lg font-bold my-2 block mx-auto text-center w-44 px-5 py-2 bg-[#99E1D9] rounded rounded-xl">Login</button>
            <span class="text-[#F0F7F4] block text-center">Have account?<a href=""
